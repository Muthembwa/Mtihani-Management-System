...
class SubjectsController extends Controller
{
    ...
    public function create()
    {
        ...
        $subject_teachers = \App\User::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function edit($id)
    {
        ...
        return view('admin.subjects.edit', compact('subject', 'subject_teachers'));
    }
    ...
    public function show($id)
    {
        ...
        $subject_teachers = \App\User::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$marks = \App\Mark::where('subject_id', $id)->get();
