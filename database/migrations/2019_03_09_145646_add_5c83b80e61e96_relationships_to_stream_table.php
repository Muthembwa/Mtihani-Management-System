...
class Add5c83b80e61e96RelationshipsToStreamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('streams', function(Blueprint $table) {
            if (!Schema::hasColumn('streams', 'class_teacher_id')) {
                ...
                $table->foreign('class_teacher_id', '275634_5c83b80c12915')->references('id')->on('roles')->onDelete('cascade');
                }
